  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="flex items-center justify-center gap-2.5 mb-8">
          <svg style={{ width: 40, height: 40 }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="currentColor">
      ...
      <div className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-[var(--radius-xl)] p-8 shadow-2xl">
        ...
        <Button
          ...
          loading={demoLoading}
        >
          <svg style={{ width: 20, height: 20 }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="currentColor">
            <polygon points="22,22 60,22 44,44 22,44" />
            <rect x="63" y="22" width="22" height="22" />
            <polygon points="44,50 63,44 63,80 44,80" />
          </svg>
